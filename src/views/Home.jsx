...
module.exports = function Home() {
  return (
    <Layout>
      ...
      <div className="flex flex-col items-center mx-auto max-w-7xl py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
        ...
        <form className="mt-8 w-3/6">
          ...
          <div className="relative">
            ...
            <button type="submit" id="search-btn" className="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
          </div>
        </form>
      </div>

      <div id="spinner-container" role="status" className="text-center invisible">
      ...
      <div id="books-container" className="flex flex-col md:flex-row justify-center items-center invisible">
        <h2>Privet</h2>
      </div>
    </Layout>
  );
