...
module.exports = function Home({ user }) {
  return (
    <Layout user={user}>
      ...
      <div className="flex flex-col items-center mx-auto max-w-7xl py-16 px-4 sm:py-24 sm:px-6 lg:px-8 h-full">
        <div className="text-center">
          <img className="h-40 w-auto mx-auto" src="images/giphy.gif" alt="GeekConsole Logo" />
          <h1 className="text-xl mb-3">Welcome to GeekConsole</h1>
        ...
        <form className="mt-8 w-3/6">
          ...
          <div className="relative">
            ...
            <input type="search" id="default-search" className="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-[#F7BE38]/50 focus:border-[#F7BE38]/50 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search books" required />
