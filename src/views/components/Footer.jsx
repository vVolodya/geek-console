        ...
        <div className="flex justify-between items-center">
          ...
          <form name="newsletter" className="flex flex-col w-full max-w-sm lg:ml-auto">
            <div className="flex">
              ...
              <button type="submit" id="send-email-button" className="w-24 py-3 px-5 text-sm text-center text-gray-900 rounded-r-lg border cursor-pointer bg-[#F7BE38] border-[#F7BE38] hover:bg-[#F7BE38]/90 focus:ring-[#F7BE38]/90">Subscribe</button>
              <button disabled id="spinner-button" type="submit" className="w-24 py-3 px-5 text-sm text-center text-gray-900 rounded-r-lg border cursor-pointer bg-[#F7BE38] border-[#F7BE38] hover:bg-[#F7BE38]/90 focus:ring-[#F7BE38]/90 hidden">
